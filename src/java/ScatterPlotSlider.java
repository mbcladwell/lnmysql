 ...
 * @since Trick 10
 */
public class ScatterPlotSlider extends JSlider implements ChangeListener{
	 ...
	 */
    public ScatterPlotSlider(double min, double max, double val, ScatterPlot _parent) {
	    super();
           DOUBLE_FACTOR = 100.0 ;
	    setUI(new ScatterPlotSliderUI(this));
	    setBorder(border);
    ...
    public ScatterPlotSlider(double min, double max, double val, double factor, ScatterPlot _parent ) {
	    super();
     ...
     */
    class ScatterPlotSliderUI extends BasicSliderUI implements MouseMotionListener, MouseListener {
        final JPopupMenu pop = new JPopupMenu();
        JMenuItem item = new JMenuItem();
       
        ScatterPlotSlider slider;
        
        /**
         * Constructor with specifed slider.
         * 
         * @param slider	The specified {@link ScatterPlotSlider}.
         */
        public ScatterPlotSliderUI(ScatterPlotSlider slider)
        {
            super(slider);
