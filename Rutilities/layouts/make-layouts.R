...
file.name <-"~/syncd/prog/plate-manager/Rutilities/layout_files/plate_layouts_for_import.sql"
file.remove(file.name)

cat("INSERT INTO plate_layout (plate_layout_name_id, well_by_col, well_type_id, replicates, target) VALUES ", file=file.name, append=TRUE)
